...
IN FOCUS > DPST AS ITS HIT SUPPORT 🤔👇
I've been asked, "*John, what is the trade?*"

And I'll tell you, DPST is set up for a decent reversal, if you're asking
me.

Back in May, you had three points of resistance testing. Then the markets
sold off because of Iran, and after that, DPST screamed higher. > Fast
forward to today and notice where it's dancing around — right at the KC
Bottom. That's been happening for a good month as interest rate hikes have
moved money from the banks into tech.

Now, with the news out and the market having had a couple of days to digest
it, DPST might have finally found a bottom.

RSI is 23 — oversold.
Trading at the KC Bottom.

The $113 strike, giving even more downside protection, could be a trade I'd
consider IF I didn't already have over $180,000 in a DPST $137 trade.

just some of my thoughts on DPST.

---

## 2026-09-22 | TRADE ALERT NOTIFICATIONS VIA THE TELEGRAM APP 🔔
_john@ucptdashboard.com - captured 2026-09-22_

TRADE ALERT NOTIFICATIONS VIA THE TELEGRAM APP  🔔
My “*homegrown*” Phone App was developed by me so I could have one place to
post all of my trade alerts and member videos. It’s been a wonderful tool
for quickly checking trades and watching videos right inside the app.

But for years, members have asked for one additional feature —
notifications that “*DING* 🔔  ” your phone whenever I post a new trade
alert.

🥺 Unfortunately, the coding behind the Phone App (the core program it was
built on) *does not allow me to send those types of push notifications.*

So, I’ve found a simple workaround using a common communication app called
Telegram.

*Here’s how it will work:*

1) I post a new trade alert to the Phone App.
2) Telegram sends a notification to your device — *DING! * 🔔
3) You open the Phone App and check the new trade alert.

I’ll be rolling this out soon for any member who wants this feature.

*NOTE: *You will be send a link to 'opt in' ... do not worry, if you do not
opt in everything will stay the same ...

*👉 To be clear, nothing is changing with the Phone App I created.* It will
continue to be updated and used exactly as it is today. Telegram is simply
an added notification feature that will “DING” your phone and let you know
that I’ve posted a new trade alert for you to check.

Same Phone App. Same trade alerts. Now with a DINGs! 🔔

*ROLLOUT = SOON (TBA) I'm still testing it*
...
TNA COULD BE A TRADE I ADD MORE  👇 🤔
With the news of interest rate hikes coming, the markets sold off the
Russell and TNA fell from $77 to $60 (intra day yesterday after the news
was announced) ... I figured with my 2,000 share trade, $61 strike that the
selling was over done and felt TNA was the value play of all the index's
... so far this morning that is proving to be the case as TNA is popping to
$64x and my guess is that it will move back to the KC MID ($66) so I'm
thinking my next trade might be ANOTHER TNA trade as I now think its back
to "normal" trading ... which should have it above $66 ... we will see
about. Stay tuned

Skin in the game - I have (2) trades open 👇

---

## 2026-09-17 | GOOGLE CHROME IS STUPID 😡 THE DOWNLOAD HUB IS NOT DANGEROUS‼️
_john@cptdashboard.com - captured 2026-09-17_

GOOGLE CHROME IS STUPID 😡  THE DOWNLOAD HUB IS NOT DANGEROUS‼️
*Every time Google updates its Chrome browser this happens:* it flags the
Download Hub, a Blogspot site they own, as dangerous and suggests it could
be harmful.

*Of course, it is not.*
Please just follow the arrows below and paste in the password and you are
in.
